                ...
                <div className="container container-two">
                    <div className="contact-form bg-white">  
                        <div className="section-heading">
                            ...
                            <p className="section-heading__desc">For your property we will do everything  advice, repairs and maintenance. We are the some preferred choice by many property owners because</p>
                        </div>
